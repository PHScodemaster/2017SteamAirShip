...
public class OI { 
    ...
    public OI() {
        ...
        button01.whileHeld(new Climb());


        // SmartDashboard Buttons
        SmartDashboard.putData("GetDistance", new GetDistance());
        SmartDashboard.putData("GetPosition", new GetPosition());
        ...
        SmartDashboard.putData("DriveForward: Trial", new DriveForward(10, 0.65));
